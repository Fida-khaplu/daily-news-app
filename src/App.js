    ...
    return (
      <div>
        <Router>
          ...
          <Routes>
            {/* <Route exact path="/about" element={<News setProgress={setProgress}  pageSize={pageSize} country ="in" category = "about"/>}>   </Route> */}
            ...
            <Route exact path="/technology"element={  <News setProgress={setProgress}  key="technology" pageSize={pageSize} country="in"category="technology" /> } >{" "} </Route> </Routes>
        </Router>
      </div>
    )
