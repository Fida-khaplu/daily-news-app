    ...
    return (
      <div>
        <Router>
          ...
          <Routes>
            {/* <Route exact path="/about" element={<News setProgress={this.setProgress}  pageSize={this.pageSize} country ="in" category = "about"/>}>   </Route> */}
            ...
            <Route exact path="/technology"element={  <News setProgress={this.setProgress}  key="technology" pageSize={this.pageSize} country="in"category="technology" /> } >{" "} </Route> </Routes>
        </Router>
      </div>
    );
  }
